...
The repository contains the front-end part of the **health-cookbook** application. This is the **MVP version** of the project.

The backend part is in a different repository and implemented on a local server.

_**Health-Cookbook** is an application with a collection of healthy recipes. 
It implements a search by recipes, by tags, and you can also put down a personal rating for the recipe. 
...
<img alt="mainPage" src="public/mainPage.jpg"> </img>

</div>

## Technology Stack
### Frontend:
HTML5, CSS3, JavaScript, React, React-router-dom, TypeScript, Axios, MobX, webpack, Ant Design
